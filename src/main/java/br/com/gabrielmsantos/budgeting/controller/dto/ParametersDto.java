...
public record ParametersDto(Long id, String name, String type, Functionalities functionality) {

    public ParametersDto(Parameters model) {
        this(model.getId(), model.getName(), model.getType(), model.getFunctionality());
    }
